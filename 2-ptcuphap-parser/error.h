...
// Cần viết vào báo cáo lỗi nào xảy ra trong các trường hợp sau:
// Cần viết lỗi xảy ra ở chỗ nào trong parser.c
// Ví dụ trong example1.kpl sửa dòng nào thành lỗi gì thì ghi vào báo cáo
...
typedef enum {
  ...
  // Chỉ đưa ra khi bắt đầu biểu thức không phải là định danh, mở ngoặc, số, +, -
  // Phải bắt lỗi này trước khi bắt lỗi ERR_INVALIDTERM và ERR_INVALIDFACTOR
